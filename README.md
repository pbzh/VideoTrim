...
- **Hardware-accelerated encoding** — frame-accurate trimming using Apple VideoToolbox (H.264, HEVC), Intel Quick Sync Video (H.264, HEVC, AV1), or AMD AMF (H.264, HEVC, AV1)
...
| H.264 (AMD AMF) | Fast | Frame-accurate | High (cqp 18) | AMD GPU (Windows) |
| HEVC (AMD AMF) | Fast | Frame-accurate | High (cqp 18) | AMD GPU (Windows) |
| AV1 (AMD AMF) | Fast | Frame-accurate | High (cqp 18) | AMD RDNA3+ (RX 7000) |
...
AV1 hardware encoding via QSV requires Intel Arc (Alchemist/DG2) or newer.

### AMD AMF requirements

- **Windows:** Install the latest AMD Adrenalin driver. AMF works on most modern Radeon GPUs and Ryzen APUs. AV1 encoding requires RDNA3 (RX 7000 series) or newer.
